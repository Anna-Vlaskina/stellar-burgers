...
export const selectIngredientsItems = (state: RootState) => state.ingredients.items;
...
export const selectProfileLoading = (state: RootState) => state.profileOrders.loading;
export const selectProfileError = (state: RootState) => state.profileOrders.error;
export const selectModalOrder = (state: RootState) => state.modal.order;